...
import org.hil.ppm.web.filter.CachingHttpHeadersFilter;
import org.hil.ppm.web.filter.StaticResourcesProductionFilter;
import org.hil.ppm.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "ppm");
