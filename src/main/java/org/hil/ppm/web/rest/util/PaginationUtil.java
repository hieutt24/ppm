package org.hil.ppm.web.rest.util;
...
public class PaginationUtil {
    ...
    public static HttpHeaders generatePaginationHttpHeaders(Page<?> page, String baseUrl, Integer offset, Integer limit, long total)
            throws URISyntaxException {
